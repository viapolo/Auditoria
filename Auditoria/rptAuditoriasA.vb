...
Public Class rptAuditoriasA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Auditoria.rptAuditoriasA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAuditoriasA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAuditoriasA = New rptAuditoriasA()
        rpt.Site = Me.Site
        Return rpt
    End Function
